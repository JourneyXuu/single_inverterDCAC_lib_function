...
SECTIONS
{
   ...
   .cinit              : > FLASHA,     PAGE = 0
   .pinit              : > FLASHA,     PAGE = 0
   .text:cio : { rts*.lib<trgmsg.obj exit.obj>(.text) } > RAML1
   .text:rts : { rts*.lib(.text) } > FLASHA
   .text > FLASHA
...
*/
   ...
   .stack              : > RAML4,      PAGE = 1		//from RAML1 change to RAML4
   .ebss               : > RAML4,      PAGE = 1
   .esysmem            : > RAML4,      PAGE = 1		//from RAML1 change to RAML4

   /* Initalized sections to go in Flash */
   /* For SDFlash to program these, they must be allocated to page 0 */
   .econst             : > FLASHC,     PAGE = 0		//change from A to C
